<?php
    ...
    if($type == 1 || $type == 2)//case type = 6, use type = 3 instead in android version and set path to type 6 instead when call type 3
    {
...
//    //*****
    ...
    $imageData = array('base64String' => $b64image);
    $arrData = array();
    array_push($arrData,$imageData);
    $response = array('success' => true, 'data' => $arrData, 'error' => null);
